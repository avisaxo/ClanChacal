...
namespace MaterialUI
{
    ...
    public static class MaterialUIEditorTools
    {
        ...
        [MenuItem("GameObject/MaterialUI/Raw Image", false, 010)]
        private static void CreateRawImage()
        {
            CreateInstance("Components/Raw Image", "Raw Image");
        }
        ...
        private static void CreateNavDrawer()
        {
            CreateInstance("Components/Nav Drawer", "Nav Drawer");
						RectTransform rectt=m_LastInstance.GetComponent<RectTransform>();
						rectt.anchorMin=Vector2.zero;
						rectt.anchorMax=new Vector3(0.73f,1f);
						rectt.anchoredPosition=new Vector2(rectt.parent.GetComponent<RectTransform>().sizeDelta.x*-0.73f,0f);
						rectt.sizeDelta = new Vector2(0, 8f);
        }
